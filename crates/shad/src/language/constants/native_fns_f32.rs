...
fn operator_runner(fn_key: &str) -> Option<fn(params: &[&ConstantValue]) -> ConstantData> {
    Some(match fn_key {
        ...
        | "`__mul__(f32, f32x2)` function"
        | "`__mul__(f32, f32x3)` function"
        | "`__mul__(f32, f32x4)` function"
        | "`__mul__(f32x2, f32)` function"
        | "`__mul__(f32x2, f32x2)` function"
        | "`__mul__(f32x3, f32)` function"
        | "`__mul__(f32x3, f32x3)` function"
        | "`__mul__(f32x4, f32)` function"
        | "`__mul__(f32x4, f32x4)` function" => |p| constants::mul(p[0], p[1]),
        "`__div__(f32, f32)` function"
        | "`__div__(f32, f32x2)` function"
        | "`__div__(f32, f32x3)` function"
        | "`__div__(f32, f32x4)` function"
        | "`__div__(f32x2, f32)` function"
        | "`__div__(f32x2, f32x2)` function"
        | "`__div__(f32x3, f32)` function"
        | "`__div__(f32x3, f32x3)` function"
        | "`__div__(f32x4, f32)` function"
