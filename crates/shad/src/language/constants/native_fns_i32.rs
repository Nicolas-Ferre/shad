...
fn operator_runner(fn_key: &str) -> Option<fn(params: &[&ConstantValue]) -> ConstantData> {
    Some(match fn_key {
        ...
        | "`__mul__(i32, i32x2)` function"
        | "`__mul__(i32, i32x3)` function"
        | "`__mul__(i32, i32x4)` function"
        | "`__mul__(i32x2, i32)` function"
        | "`__mul__(i32x2, i32x2)` function"
        | "`__mul__(i32x3, i32)` function"
        | "`__mul__(i32x3, i32x3)` function"
        | "`__mul__(i32x4, i32)` function"
        | "`__mul__(i32x4, i32x4)` function" => |p| constants::mul(p[0], p[1]),
        "`__div__(i32, i32)` function"
        | "`__div__(i32, i32x2)` function"
        | "`__div__(i32, i32x3)` function"
        | "`__div__(i32, i32x4)` function"
        | "`__div__(i32x2, i32)` function"
        | "`__div__(i32x2, i32x2)` function"
        | "`__div__(i32x3, i32)` function"
        | "`__div__(i32x3, i32x3)` function"
        | "`__div__(i32x4, i32)` function"
        | "`__div__(i32x4, i32x4)` function" => |p| constants::div(p[0], p[1]),
        "`__mod__(i32, i32)` function"
        | "`__mod__(i32, i32x2)` function"
        | "`__mod__(i32, i32x3)` function"
        | "`__mod__(i32, i32x4)` function"
        | "`__mod__(i32x2, i32)` function"
        | "`__mod__(i32x2, i32x2)` function"
        | "`__mod__(i32x3, i32)` function"
        | "`__mod__(i32x3, i32x3)` function"
        | "`__mod__(i32x4, i32)` function"
